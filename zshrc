...
alias reconnect="sudo systemctl restart openvpn@goku.service && sleep 10s && sudo systemctl restart stubby"
...
if [ -f '/home/tomw/google-cloud-sdk/completion.zsh.inc' ]; then . '/home/tomw/google-cloud-sdk/completion.zsh.inc'; fi
